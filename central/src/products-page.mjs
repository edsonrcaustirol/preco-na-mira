...
<section class="detail" id="detail" hidden aria-labelledby="detail-title"><div class="detail-head"><div><div class="muted">Detalhe read-only · projeção derivada do owner canônico</div><h2 id="detail-title"></h2></div><button class="close" id="detail-close" type="button">Fechar</button></div><div class="detail-grid"><section class="section"><h3>DADOS DO PRODUTO — CANÔNICO</h3><div id="detail-data"></div></section><section class="section"><h3>PUBLICAÇÃO — DADO CANÔNICO</h3><div id="detail-publication"></div></section><section class="section"><h3>LINK MERCADO LIVRE — CANÔNICO</h3><span class="affiliate" id="detail-url"></span><div class="actions"><button id="detail-copy" type="button">Copiar</button><a id="detail-open" href="#" target="_blank" rel="noopener noreferrer sponsored">Abrir</a></div></section><section class="section"><h3>DADO DERIVADO — PÁGINA PÚBLICA</h3><p class="muted">A página é derivada do ID canônico e validada pelo E2.</p><div class="actions"><a id="detail-public-page" href="#" target="_blank" rel="noopener noreferrer">Abrir página pública</a></div></section><section class="section"><h3>SAÚDE DO LINK</h3><p>Saúde dos links será integrada na próxima etapa.</p></section><section class="section"><h3>AÇÕES</h3><div class="actions"><button type="button" disabled>EDITAR</button><button type="button" disabled>NOVO PRODUTO</button></div></section></div></section>
