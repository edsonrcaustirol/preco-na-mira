...
const queryLink=new URLSearchParams(location.search).get('link');if(queryLink&&!String(link.value||'').trim()){link.value=queryLink;form.dispatchEvent(new Event('input',{bubbles:true}));history.replaceState({},'', '/novo-produto');}
