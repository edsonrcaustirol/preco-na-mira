...
(function(){
  const U=[
    ...
    {id:'gamer',icon:'🎮',nome:'Gamer',status:'ativo',href:'ambiente-gamer.html',cor:'roxo',descricao:'PC por peças, notebooks, monitores e periféricos em uma experiência conectada.'},
    {id:'tecnologia',icon:'📱',nome:'Tecnologia',status:'ativo',href:'universo-tecnologia.html',cor:'azul',descricao:'Celulares, wearables, áudio, acessórios, notebooks, conectividade e ecossistemas pessoais.'},
  ...
  const A=[
    {id:'sala-cinema',universo:'casa',icon:'🛋️',nome:'Sala & Cinema',status:'ativo',href:'cinema-em-casa.html',descricao:'TV ou projetor, áudio e equipamentos que transformam a sala.'},
    {id:'casa-inteligente',universo:'casa',icon:'🏠',nome:'Casa Inteligente',status:'ativo',href:'ambiente-casa.html',descricao:'Assistentes, Wi-Fi, iluminação, energia, segurança, acesso e limpeza.'},
    {id:'home-office',universo:'casa',icon:'💻',nome:'Home Office / Gamer',status:'ativo',href:'ambiente-gamer.html',descricao:'Computador, monitor, periféricos e conectividade para trabalhar ou jogar.'},
    {id:'cozinha',universo:'casa',icon:'🍳',nome:'Cozinha',status:'ativo',href:'ambiente-cozinha.html',descricao:'Preparar, cozinhar, servir e montar uma cozinha coerente por função, cor e acabamento.'},
    {id:'pequenos-espacos',universo:'casa',icon:'📐',nome:'Pequenos Espaços',status:'ativo',href:'pequenos-espacos.html',descricao:'Soluções para studios, kitnets e apartamentos compactos, com atenção a uso, circulação e medidas.'},
    ...
    {id:'lavanderia',universo:'casa',icon:'🧺',nome:'Lavanderia',status:'ativo',href:'lavanderia.html',descricao:'Lavagem e cuidado com roupas separados entre pouco espaço e maior capacidade.'},
    {id:'banheiro',universo:'casa',icon:'🚿',nome:'Banheiro',status:'ativo',href:'acabamentos.html?tipo=louca-sanitaria',descricao:'Louças, cubas, metais, duchas, iluminação e acessórios para o banheiro.'},
    ...
    {id:'obra-base',universo:'casa',icon:'🧱',nome:'Obra base',status:'ativo',href:'obra-base.html',descricao:'Impermeabilização, vedação, cobertura, ferramentas e proteção para o começo da obra.'},
    {id:'instalacoes',universo:'casa',icon:'⚡',nome:'Instalações',status:'ativo',href:'instalacoes.html',descricao:'Elétrica, iluminação, banho, bombas, pressurização e aquecimento organizados por função.'},
    {id:'acabamentos',universo:'casa',icon:'🎨',nome:'Acabamentos',status:'ativo',href:'acabamentos.html',descricao:'Rejuntes, tintas, massas, texturas, louças, cubas, metais, fechaduras e iluminação decorativa.'},
    {id:'mobile',universo:'tecnologia',icon:'📱',nome:'Ecossistema móvel',status:'ativo',href:'setup-ecossistema.html',descricao:'Celular, relógio, fone, energia e acessórios trabalhando como conjunto.'},
    {id:'audio-portatil',universo:'tecnologia',icon:'🎧',nome:'Áudio pessoal',status:'ativo',href:'fones-de-ouvido.html',descricao:'Fones e caixas para música, chamadas, treino e mobilidade.'},
    {id:'computacao',universo:'tecnologia',icon:'🖥️',nome:'Computação',status:'ativo',href:'notebooks.html',descricao:'Notebooks, monitores, memória e acessórios para diferentes usos.'},
    {id:'acessorios-tech',universo:'tecnologia',icon:'🔌',nome:'Acessórios Tech',status:'ativo',href:'acessorios-tech.html',descricao:'Power banks, carregadores GaN, hubs USB-C e upgrades de notebook.'},
    {id:'conectividade',universo:'tecnologia',icon:'🌐',nome:'Conectividade',status:'ativo',href:'internet.html',descricao:'Internet, Wi-Fi e infraestrutura para manter seus dispositivos conectados.'},
    {id:'pc-gamer',universo:'gamer',icon:'🧩',nome:'PC Gamer',status:'ativo',href:'montar-pc.html',descricao:'Escolha as peças em sequência e acompanhe compatibilidades importantes.'},
    {id:'setup-gamer',universo:'gamer',icon:'🎮',nome:'Setup Gamer',status:'ativo',href:'ambiente-gamer.html',descricao:'PC, monitor, teclado, mouse, áudio e acessórios no mesmo espaço.'}
  ];
  const J=[
    {id:'primeira-casa',icon:'🏡',nome:'Minha casa',status:'ativo',href:'minha-casa.html',descricao:'Transforme ideias em um projeto vivo e avance por ambientes e etapas.'},
    {id:'casa-studio',icon:'✏️',nome:'Meu projeto de casa',status:'ativo',href:'casa-studio.html',descricao:'Escolha ambiente, estilo, paleta, registre ideias e descubra combinações.'},
    {id:'espaco-compacto',icon:'📐',nome:'Meu espaço compacto',status:'ativo',href:'montar-espaco-compacto.html',descricao:'Defina perfil, prioridade e restrições para receber uma seleção de categorias adequadas ao pouco espaço.'},
    {id:'cozinha-pratica',icon:'🍳',nome:'Minha cozinha',status:'ativo',href:'montar-cozinha.html',descricao:'Monte os principais eletroportáteis e acompanhe coerência visual do conjunto.'},
    {id:'cafe',icon:'☕',nome:'Meu cantinho do café',status:'ativo',href:'montar-cozinha.html?modo=cafe',descricao:'Escolha o tipo de café, cafeteira e complementos para o seu espaço.'},
    {id:'pc-gamer',icon:'🎮',nome:'Meu PC gamer',status:'ativo',href:'montar-pc.html',descricao:'CPU, placa-mãe, RAM, GPU, fonte, gabinete e periféricos.'},
    {id:'cinema',icon:'🎬',nome:'Meu cinema em casa',status:'ativo',href:'cinema-em-casa.html',descricao:'Escolha TV ou projetor e complete com áudio.'},
